  ...
  return (
    ...
    <div className='lg:flex justify-center align-center w-[100%]'>
      <div className='lg:w-[50%] md:p-10 font-sans'>    
        ...
        <p className="relative text-white text-lg md:text-xl text-center flex items-center mb-8 bg-[#ff0080a2] md:p-10 p-5 rounded-xl">
      ...
      <div className='lg:w-[50%] md:p-10 font-sans'>
        ...
        <p className="text-white text-lg md:text-xl text-center flex items-center mb-8 bg-[#c300ffa2] md:p-10 p-5 rounded-xl">
